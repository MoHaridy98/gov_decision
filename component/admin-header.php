...
echo "
    ...
    <div class='navbar-header'>
        ...
        <a class='navbar-brand' style='font-size: x-large; display:flex;' href='admin.php'><img style='width: 40px; height: 40px; margin: -10px 0 0 10px; border-radius: 5px;' src='images/logo.png'>قرارات وتكليفات</a>
    </div>
    <!-- navbar-header -->
    ...
    <div class='sidebar-nav navbar-collapse'>
        <ul class='nav' id='side-menu'>
            <li>
                <a href='admin.php'><i class='fa fa-user fa-fw'></i> مستخدمين الموقع </a>
            </li>                
            <li>
                <a href='new-type.php'><i class='fa fa-table fa-fw'></i> تصنيفات المستخدمين </a>
            </li>                
        </ul>                    
    </div>
    <!-- /.sidebar-collapse -->
